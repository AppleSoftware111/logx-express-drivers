...
export enum ApiErrorCode {
  ...
  EXECUTION_CANNOT_CREATE_FOLLOW_UP = 'EXECUTION_CANNOT_CREATE_FOLLOW_UP',
  EXECUTION_OPEN_ALREADY_EXISTS = 'EXECUTION_OPEN_ALREADY_EXISTS',
  NO_NEW_STOPS_FOR_FOLLOW_UP = 'NO_NEW_STOPS_FOR_FOLLOW_UP',
